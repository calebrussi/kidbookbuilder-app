...
async function convertConfig({
  ...
  try {
    ...
    // Write the transformed configuration to the output file only if DEBUG is enabled
    if (process.env.DEBUG === "true") {
      ...
      console.log(
        `Configuration transformed successfully (file output disabled - set DEBUG=true to save files)`
      );
    }
