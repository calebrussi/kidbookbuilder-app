  ...
  return (
    <div className="space-y-0">
      ...
      {showDebug && (
        ...
        //   <h4 className="font-semibold mb-1">Debug Info for: {title}</h4>
        //   <pre className="overflow-auto max-h-40 bg-gray-200 p-2 rounded">
        //     {JSON.stringify({ id, status, conversationStatus, success, capturedData }, null, 2)}
        //   </pre>
        // </div>
